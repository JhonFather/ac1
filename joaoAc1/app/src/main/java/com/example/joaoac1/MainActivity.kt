        ...
        fun calculaIdade(componente: View) {
            ...
            if(nome == "" || nome.length <=3 || pai <= 0 || mae <= 0){
                ...
                if(idadeMorte > 60){
                    ...
                    campo6.text = "${nome} você vai morrer com ${idadeMorte} - velho"
                }else if(idadeMorte > 20){
                    campo6.setTextColor(Color.YELLOW)
                    campo6.text = "${nome} você vai morrer com ${idadeMorte} - jovem"
                }else {
                    campo6.setTextColor(Color.RED)
                    campo6.text = "${nome} você vai morrer com ${idadeMorte} - MUITO jovem"
                }
